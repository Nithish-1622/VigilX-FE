...
import { Bot, Copy, Check, ThumbsUp, ThumbsDown, RefreshCw, Volume2, Sparkles, Code, CheckCircle2 } from 'lucide-react'

// Simple Markdown / Rich Text parser for ChatGPT-like formatting
...
export default function ChatGPTResponse({ text, timestamp, onRegenerate }) {
  const [copied, setCopied] = useState(false)
  ...
  return (
    <div style={{
      ...
      {/* Interactive Action Bar (ChatGPT Style) */}
      <div style={{
        display: 'flex',
        alignItems: 'center',
        justify: 'space-between',
